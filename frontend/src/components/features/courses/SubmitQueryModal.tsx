...
export function SubmitQueryModal({ courseId, courseName, onClose, onSuccess }: SubmitQueryModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await courseQueryService.create(courseId, { category, message });
            onSuccess();
        } catch (error: any) {
        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "20px 24px", borderBottom: "1px solid #F3F4F6", background: "#F9FAFB" }}>
                    <div>
                        <h2 style={{ fontSize: 18, fontWeight: 700, color: "#111827", margin: 0 }}>Contact Coordinator</h2>
                        <p style={{ fontSize: 13, color: "#6B7280", margin: "4px 0 0" }}>{courseName}</p>
                    </div>
                    ...
                    <div style={{ display: "flex", justifyContent: "flex-end", gap: 12 }}>
                        ...
                        <button
                            ...
                            style={{
                                ...
                                background: isSubmitting ? "#A7F3D0" : "#10B981", color: "white",
