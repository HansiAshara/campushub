    ...
    return (
        <div style={{ display: "flex", minHeight: "100vh" }}>
            ...
            >
                ...
                <div style={{ fontSize: 12, color: "#7C8B86" }}>Free for all current students.</div>
            </div>
            ...
            <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", backgroundColor: "var(--color-paper)" }}>
                <div style={{ width: 360 }}>
                    ...
                    <p style={{ marginTop: 20, fontSize: 14, color: "var(--color-text-muted)" }}>
                        Already have an account? <Link to="/auth/login" style={{ color: "var(--color-ink)", fontWeight: 600 }}>Log in</Link>
                    </p>
                </div>
            </div>
        </div>
