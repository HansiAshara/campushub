...
function UploadResourcePage() {
    ...
    return (
        <div style={{ maxWidth: 520 }}>
            ...
            <h1 style={{ fontSize: 24, margin: "10px 0 24px" }}>Share a resource</h1>
                ...
                <form onSubmit={handleUpload}>
                    ...
                    <div style={{ marginBottom: 16 }}>
                        ...
                        <select value={resourceType} onChange={(e) => setResourceType(e.target.value)}
                            style={{ width: "100%", padding: "11px 12px", borderRadius: 8, border: "1px solid var(--color-border)", fontSize: 14 }}>
                    ...
                    <div style={{ marginBottom: 16 }}>
                        ...
                        <label
                            ...
                            style={{
                                ...
                                padding: "28px 16px", border: `1.5px dashed ${dragActive ? "var(--color-primary)" : "var(--color-border)"}`,
                                borderRadius: 10, backgroundColor: dragActive ? "var(--color-secondary)" : "var(--color-bg)",
                                cursor: "pointer", textAlign: "center",
                            }}>
                            <input type="file" onChange={(e) => setFile(e.target.files?.[0] || null)} style={{ display: "none" }} required />
                            <span style={{ fontSize: 14, fontWeight: 500 }}>{file ? file.name : "Drop a file here, or click to browse"}</span>
                    ...
                    <Button type="submit" variant="accent" fullWidth disabled={uploading}>{uploading ? "Uploading..." : "Upload Resource"}</Button>
                </form>
            </Card>
        </div>
    );
